...
import Index2 from '@/views/static/index2.vue'
import Index3 from '@/views/static/index3.vue'
...
const routes = [
    {
        path: '/category',//访问路径 http://127.0.0.1:5173/cx/XfDGdOkjVo7deIxQjurcf8BEnNf 
        name: 'category', //命名路由
        component: Index,   //key:value  默认//页面组件 components 普通组件 页面组件和普通组件是一对多
    },
    {
        path: '/topic',//访问路径 http://127.0.0.1:5173/cx/XfDGdOkjVo7deIxQjurcf8BEnNf 
        name: 'topic', //命名路由
        component: Index2,   //key:value  默认//页面组件 components 普通组件 页面组件和普通组件是一对多
    },
    {
        path: '/comment',//访问路径 http://127.0.0.1:5173/cx/XfDGdOkjVo7deIxQjurcf8BEnNf 
        name: 'comment', //命名路由
        component: Index3,   //key:value  默认//页面组件 components 普通组件 页面组件和普通组件是一对多
    },
    // {
    //     path: '/adcate',
    //     name: 'adCate',
